 ...
 * Специфичные (Ti/W/Co/Al/As/B/N) — опциональные, появляются только у тех
 * марок, где стандарт явно их нормирует (B — для борсодержащих,
 * N — нормируется у ряда аустенитных, влияет на PREN).
 */
